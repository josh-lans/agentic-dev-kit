...
The methodology was developed and refined across **three production systems and hundreds of structured sessions** — an enterprise observability platform, an AI-augmented migration engine, and a cross-platform game. It's tool-agnostic: it works with any AI coding assistant that can read your project files.

**Source:** [agentic-dev-kit](https://github.com/josh-lans/agentic-dev-kit) by Joshua Lans
